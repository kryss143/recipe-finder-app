<template>
  <div class="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow">
    ...
    <input
      ...
      class="w-full border rounded-lg px-4 py-2 mb-5 focus:outline-none focus:ring-2 focus:ring-orange-400 placeholder-shown:placeholder-gray-400 text-gray-600 placeholder-gray-800:"
    />
    ...
    <p class="text-sm text-center mt-4 text-gray-500">
      ...
      <RouterLink to="/login" class="text-orange-500 hover:underline"
        >Login</RouterLink
      >
    </p>
  </div>
